...
function FalseGame() {
	...
	textDisplayPoint = "<img src='./img/false.jpg' style='max-width: 120px; margin-bottom: 20px;'><div class='text-false'>คุณทายผลตัวเลขผิด</div>คุณทำคะแนนในเกมส์นี้ได้ = <b>"+ ScorePoint +" คะแนน</b><br>แล้วกลับมาเล่นใหม่ในวันพรุ่งนี้น้า";
...
function TrueGame() {
	...
	textDisplayPoint = "<img src='./img/ok.jpg' style='max-width: 120px; margin-bottom: 20px;'><div class='text-false'>สรุปผลคะแนนการแข่งขันของคุณในรอบนี้</div>คุณทำคะแนนในเกมส์นี้ได้ = <b>"+ ScorePoint +" คะแนน</b><br>แล้วกลับมาเล่นใหม่ในวันพรุ่งนี้น้า";
...
function LinkMainPage(){
	window.location.href='startcheck.html';
}
